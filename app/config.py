...
class Settings:
    # --- GCP Core ---
    PROJECT_ID = os.getenv("PROJECT_ID", "production-advanced-rag")
    LOCATION = os.getenv("LOCATION", "us-central1")
    GCP_DOC_AI_LOCATION = os.getenv("GCP_DOC_AI_LOCATION", "us")
    GCP_DOC_AI_PROCESSOR_ID = os.getenv("GCP_DOC_AI_PROCESSOR_ID")
    RAW_BUCKET = os.getenv("GCP_RAW_BUCKET", "production-advanced-rag-raw")
    PROCESSED_BUCKET = os.getenv("GCP_PROCESSED_BUCKET", "production-advanced-rag-processed")
    ...
    LANGSMITH_PROJECT = os.getenv("LANGSMITH_PROJECT", "Production_Rag")
...
os.environ["LANGCHAIN_PROJECT"] = os.getenv("LANGSMITH_PROJECT", "Production_Rag")
